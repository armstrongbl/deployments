...
PATH_INSTALL_NETCOOL_ITNM	= $(PATH_INSTALL_NETCOOL)/webgui
...
#WAS_JAZZSM_ITNM_USER_ID=ncoadmin
...
MEDIA_STEP1_F	:= $(PATH_MAKEFILE_MEDIA)/ITNM/4.2/1.2.0.18-Tivoli-PRS-Unix-fp0001.tar
MEDIA_STEP2_F	:= $(PATH_MAKEFILE_MEDIA)/ITNM/4.2/ITNP_IP_LIN.zip
...
<agent-input>
  ...
  <profile id='IBM Netcool Core Components' installLocation='$(PATH_INSTALL_PRECISION)'>
    ...
    <data key='user.itnm.ObjectServerItnmUserPassword.confirm,com.ibm.tivoli.netcool.itnm.core' value='$(ITNM_USER)'/>
    <data key='user.itnm.ObjectServerItnmUserPassword,com.ibm.tivoli.netcool.itnm.core' value='$(ITNM_USER)'/>
    <data key='user.itnm.database.server.type,com.ibm.tivoli.netcool.itnm.core' value='$(DB_TYPE)'/>
    <data key='user.itnm.database.skip.validation,com.ibm.tivoli.netcool.itnm.core' value='false'/>
  ...
  <install>
    <!-- Network Manager Core Components 4.2 -->
    <offering profile='IBM Netcool Core Components' id='$(PATH_REPOSITORY_ITNM_PACKAGE)' version='4.2.0.20160131_0807' features='itnm.core,non.fips.compliant'/>
  </install>
